...
void Chunk_Loader::checkPickup(Player_Inventory& inventory, Player& player, bool pickup_all, float delta_time)
{
    sf::Vector2f player_pos = player.getPosition();
    const static float move_threshold = 192.f;
    const static float speed = 4.5f * delta_time; // need to pass the delta for this
